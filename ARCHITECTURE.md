...
- Dock icon reopen: `applicationShouldHandleReopen` restores the main window when clicked with no visible windows, or when clicked a second time while the app is already active and the library window has been closed
