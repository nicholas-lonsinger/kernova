...
- A card makes no lock claim of its own. The `lock.fill` hint belongs on a panel's section header, beside the controls it covers; on a card, where live switches sit next to locked rows, any claim short enough to fit is too vague to act on.
