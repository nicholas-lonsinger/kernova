...
| [GUESTEXEC.md](GUESTEXEC.md) | Touching host→guest command execution — the guest-exec subsystem's security principles and boundaries; authoritative for any guest-exec work |
